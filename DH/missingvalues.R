...
head(sleep)
dim(sleep)
complete.cases(sleep)   #telling which rows has completet data 
sleep[complete.cases(sleep),]
sleep[!complete.cases(sleep),]

is.na(sleep$Dream)
sum(is.na(sleep$Dream))   # how many values are missing in colms t=1
mean(is.na(sleep$Dream)) #it will tell how many %of data is complete
12/62
